...
const AdminPanel: React.FC<AdminPanelProps> = ({ isOpen, onClose, user, notes, userProfile, onSpyUser, lang = 'pt', setLang }) => {
        ...
        try {
            ...
            for (let i = 0; i < 10; i++) {
                ...
                const note: NoteData = {
                    id,
                    type: 'note',
                    title: `Teste Auto ${i + 1} `,
                    content: 'Nota gerada automaticamente pelo painel de admin para teste de carga.',
                    color,
                            ...
                            <div className="flex items-center gap-3">
                                {setLang && (
                                    <button
                                        ...
                                        className="text-xs font-bold px-2 py-1 rounded bg-gray-800 hover:bg-gray-700 text-gray-400 hover:text-white flex items-center gap-1 border border-gray-700 transition-colors"
                                    >
